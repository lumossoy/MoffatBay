...
<!-- Purpose: Website page detailing a king room  -->
...
<body>
    ...
    <div class="container">
        ...
        <div class="roomNav">
            <ul>
                ...
                <li><a href="king.jsp" style="color: #1CADFB">King</a></li>
            </ul>
        </div>
        <hr width="100%" size="2">
    </div>
    <div class="content">
        <div class="top">
            <img src="images/king.png" alt="King Bed" style="width:350px">
            <p style="color: #1CADFB">One King Sized Bed</p>
        </div>
        <div class="card">
