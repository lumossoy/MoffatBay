...
<body>
	...
	<div class="container">
		...
		<p style="font-weight: bold;">Please login to continue.</p>
		<br>
		<br>
		<br>
		<form action="login" method="post">
			<label for="email">Email:</label><br> <input type="email"
				placeholder="Enter Email" name="email" size="30"> <br>
			<br> <label for="password">Password:</label><br> <input
				type="password" placeholder="Password" name="password" size="30"><br>
			<br>
